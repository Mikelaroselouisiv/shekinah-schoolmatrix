...
export const WORK_TAB_BY_ROLE: Record<string, { screenId: string; secondaryScreenIds?: string[] }> = {
  ...
  DIRECTEUR_ADMINISTRATIF: { screenId: "home-operations" },
  ADMINISTRATEUR: { screenId: "home-operations" },
  SCHOOL_ADMIN: { screenId: "home-operations" },
  DIRECTEUR_PEDAGOGIQUE_PRESCOLAIRE: { screenId: "grades", secondaryScreenIds: ["schedule", "stats-academiques"] },
  DIRECTEUR_PEDAGOGIQUE_FONDAMENTAL: { screenId: "grades", secondaryScreenIds: ["schedule", "stats-academiques"] },
  DIRECTEUR_PEDAGOGIQUE_FONDAMENTAL_2: { screenId: "grades", secondaryScreenIds: ["schedule", "stats-academiques"] },
  DIRECTEUR_PEDAGOGIQUE_FONDAMENTAL_3: { screenId: "grades", secondaryScreenIds: ["schedule", "stats-academiques"] },
  DIRECTEUR_PEDAGOGIQUE_SECONDAIRE: { screenId: "grades", secondaryScreenIds: ["schedule", "stats-academiques"] },
  DIRECTEUR_PEDAGOGIQUE_FORMATION_SUPERIEURE: { screenId: "grades", secondaryScreenIds: ["schedule", "stats-academiques"] },
  SECRETAIRE_GENERAL: { screenId: "students", secondaryScreenIds: ["fiche-eleve"] },
  SECRETAIRE_FORMATION_SUPERIEURE: { screenId: "students", secondaryScreenIds: ["fiche-eleve"] },
