 ...
 * Refuse explicitement la VM GCP (ne pas pousser le seed DEV vers Shekinah).
 */
...
if (/34\.118\.138\.96|googleapis|shekinah-schoolmatrix\.|run\.app/i.test(remote)) {
...
const env = {
  ...
  SYNC_API_KEY: process.env.SYNC_API_KEY || 'shekinah-dev-sync-lab',
